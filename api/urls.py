...
from api.core.accounts import AccountsView
from api.core.members import MembersView
from api.core.events import EventsView
from api.core.transactions import TransactionsView
...
urlpatterns = [
    ...
    # TENDERING (PAYMENTS TYPE)
    # ACCOUNTS' ROUTES
    ##############################
    # Get All Accounts
    path(
        "<str:lang>/daco/accounts/",
        AccountsView.getAllAccounts.as_view(),
        name="get-all-accounts"
    ),
    # Create Account
    path(
        "<str:lang>/daco/create/account/",
        AccountsView.createAccount.as_view(),
        name="create-account"
    ),
    # Get Account By Id
    path(
        "<str:lang>/daco/account/<int:accountid>",
        AccountsView.getAccountById.as_view(),
        name="get-account"
    ),
    ...
    # Get All Memebers
    path(
        "<str:lang>/daco/members/",
        MembersView.getAllMembers.as_view(),
        name="get-all-members"
    ),
    # Register Member 
    path(
        "<str:lang>/daco/register/member/",
        MembersView.registerMember.as_view(),
        name="register-member"
    ),
    # Get Account By Id
    path(
        "<str:lang>/daco/member/<int:memberid>",
        MembersView.getMemberById.as_view(),
        name="get-member"
    ),
    ...
    # Get All Events
    path(
        "<str:lang>/daco/events/",
        EventsView.getAllEvents.as_view(),
        name="get-all-events"
    ),
    # Get Event By Id
    path(
        "<str:lang>/daco/event/<int:eventid>",
        EventsView.getEventById.as_view(),
        name="get-event-by-id"
    ),
    # Create Event
    path(
        "<str:lang>/daco/create/event/",
        EventsView.createEvent.as_view(),
        name="create-event"
    ),
    ...
    # Get All Transations
    path(
        "<str:lang>/daco/transactions/",
        TransactionsView.getAllTransactions.as_view(),
        name="get-all-transactions"
    ),
    # Get Transaction By Id
    path(
        "<str:lang>/daco/transaction/<int:transactionid>",
        TransactionsView.getTransactionById.as_view(),
        name="get-transaction-by-id"
    ),
    # Create Transaction
    path(
        "<str:lang>/daco/register/transaction/",
        TransactionsView.registerTransaction.as_view(),
